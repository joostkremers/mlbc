#+TITLE: Deep Learning Bookcamp, ch. 2
#+PROPERTY: header-args:python :session ch2
...
#+begin_src python :results file figures/figure2-1.png
...
#+RESULTS:
[[file:figures/figure2-1.png]]

#+begin_src python :results file figures/figure2-2.png
...
#+begin_src python :results file figures/figure2-3.png
...
- X^{T} is the *transpose* of X (=4X.T= in Numpy)
...
g(x) = w_{0} + x_{1}w_{1} + x_{2}w_{}_{2} + x_{3}w_{3} + ...
...
#+begin_src python :results file ~/figures/figure2-4.png
  plt.clf()
...
#+begin_src python :results file ~/figures/figure2-5.png
  plt.clf()
  sns.histplot(y_pred, label='pred')
