...
#+begin_src python :results file figures/figure1.png
...
#+begin_src python :results file figures/figure2.png
...
#+begin_src python :results file figures/figure3.png
...
#+begin_src python :results file ~/figures/figure4.png
  plt.clf()
...
#+begin_src python :results file ~/figures/figure5.png
  plt.clf()
  sns.histplot(y_pred, label='pred')
